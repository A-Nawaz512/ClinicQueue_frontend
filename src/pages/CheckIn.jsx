...
const CheckIn = () => {
  ...
  return (
    <div className="min-h-screen px-4 pt-6 md:pt-10 bg-neutral-100 flex items-center flex-col">

      <Link to={user ? "/dashboard" : "/login"} className="bg-gray-600 hover:bg-gray-900 text-white font-semibold py-2.5 rounded-lg transition-all disabled:opacity-50 disabled:cursor-not-allowed text-sm md:text-base px-5 me-auto ">  <button
